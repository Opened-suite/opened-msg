...
<html lang="en">
    ...
    <div class="animation">
        ...
        <div class="avion">
            <img width="50" height="50" src="https://img.icons8.com/ios/FFFFFF/50/paper-plane--v1.png" alt="paper-plane--v1"/>
        </div>
    </div>
  ...
  <div class="state state--sent">
    ...
    <script>
        ...
        btn1.addEventListener('click', function() {
            window.location.href = '/form/v1/inscription/index.php';
        });
    </script>
</html>